...
public class OraAllasokActivity extends AppCompatActivity {

    private static final String LOG_TAG = OraAllasokActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ora_allasok);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView <?> parent, View view, int position, long id) {
                ...
                ref.delete().addOnSuccessListener(success -> {
                    Toast.makeText(OraAllasokActivity.this, "Sort sikeresen törölted", Toast.LENGTH_SHORT).show();
                    finish();
                });
                 }
        });
